...
var RadAutoCompleteTextView = (function (_super) {
    ...
    RadAutoCompleteTextView.prototype.createNativeView = function () {
        ...
        this._android.addTextChangedListener(new com.telerik.widget.autocomplete.TextChangedListener({
            onTextChanged: function (autoComplete, text) {
                if (that.get().text !== text) {
                    var args = new commonModule.AutoCompleteEventData(that.get(), commonModule.RadAutoCompleteTextView.textChangedEvent, text, undefined);
                    that.get().text = text;
                    that.get().notify(args);
                }
            }
    ...
    RadAutoCompleteTextView.prototype.adjustText = function (value) {
        if (this._android && this._android.getTextField().getText() !== value) {
