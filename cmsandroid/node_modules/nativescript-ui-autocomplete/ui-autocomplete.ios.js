...
var SuggestionViewDataSourceImpl = (function (_super) {
    ...
    SuggestionViewDataSourceImpl.prototype.collectionViewNumberOfItemsInSection = function (collectionView, section) {
        ...
        return owner.suggestionView.ios.items ? owner.suggestionView.ios.items.count : 0;
    };
    SuggestionViewDataSourceImpl.prototype.collectionViewCellForItemAtIndexPath = function (collectionView, indexPath) {
        ...
        if (!cell.owner) {
            ...
            template.itemView = owner.getViewForViewType(commonModule.AutoCompleteViewTypes.ItemView);
            cell.view = template;
            cell.contentView.addSubview(template.itemView.ios);
            owner._addView(template.itemView);
        }
        var model = owner.filteredItems[indexPath.row];
...
var AutoCompleteAsyncDataSourceImpl = (function (_super) {
    ...
    AutoCompleteAsyncDataSourceImpl.prototype.autoCompleteCompletionsForString = function (autocomplete, input) {
        ...
        owner.asyncCall(input).then(function (items) {
            ...
            if (radAutoComplete.completionMode === commonModule.CompletionMode.StartsWith) {
            ...
            radAutoComplete.filteredItems = nsResult;
